...
export const Card: React.FC<CardProps> = ({ title, subtitle, description, onClick, imageUrl }) => {
  return (
    <button
      onClick={onClick}
    ...
    >
      <div className="flex-grow">
        <img src={imageUrl} alt={subtitle} className="w-full h-48 object-contain mb-4" />
