...
const createFallbackSignals = (): VolunteerSignal[] => {
  const rows = [
    { municipio: 'Medellín', comite: 'Territorial', profesion: 'Educacion', publicidad: ['Volantes', 'Digital'], count: 34 },
    { municipio: 'Bello', comite: 'Movilizacion', profesion: 'Comercio', publicidad: ['Afiches para ventana', 'Volantes'], count: 18 },
    { municipio: 'Itagüí', comite: 'Logistica', profesion: 'Independiente', publicidad: ['Digital', 'Stickers'], count: 13 },
    { municipio: 'Envigado', comite: 'Comunicaciones', profesion: 'Profesional', publicidad: ['Digital', 'Afiches para ventana'], count: 11 },
    { municipio: 'Sabaneta', comite: 'Territorial', profesion: 'Estudiante', publicidad: ['Stickers', 'Digital'], count: 8 },
    { municipio: 'Copacabana', comite: 'Movilizacion', profesion: 'Comercio', publicidad: ['Volantes', 'Balconeros'], count: 7 },
    { municipio: 'Caldas', comite: 'Territorial', profesion: 'Empleado', publicidad: ['Volantes'], count: 6 },
    { municipio: 'La Estrella', comite: 'Logistica', profesion: 'Independiente', publicidad: ['Afiches para ventana'], count: 6 },
    { municipio: 'Girardota', comite: 'Territorial', profesion: 'Empleado', publicidad: ['Volantes', 'Digital'], count: 5 },
    { municipio: 'Barbosa', comite: 'Movilizacion', profesion: 'Lider comunitario', publicidad: ['Pasacalles', 'Volantes'], count: 4 },
    { municipio: 'Rionegro', comite: 'Comunicaciones', profesion: 'Profesional', publicidad: ['Digital'], count: 9 },
    { municipio: 'Marinilla', comite: 'Territorial', profesion: 'Educacion', publicidad: ['Afiches para ventana', 'Volantes'], count: 6 },
    { municipio: 'La Ceja', comite: 'Movilizacion', profesion: 'Comercio', publicidad: ['Stickers', 'Digital'], count: 5 },
    { municipio: 'Turbo', comite: 'Territorial', profesion: 'Lider comunitario', publicidad: ['Pasacalles', 'Volantes'], count: 7 },
    { municipio: 'Apartadó', comite: 'Logistica', profesion: 'Empleado', publicidad: ['Balconeros', 'Volantes'], count: 6 },
    { municipio: 'Carepa', comite: 'Territorial', profesion: 'Independiente', publicidad: ['Volantes'], count: 4 },
    { municipio: 'Caucasia', comite: 'Movilizacion', profesion: 'Comercio', publicidad: ['Digital', 'Volantes'], count: 5 },
    { municipio: 'Segovia', comite: 'Territorial', profesion: 'Lider comunitario', publicidad: ['Afiches para ventana'], count: 3 },
    { municipio: 'La Pintada', comite: 'Logistica', profesion: 'Empleado', publicidad: ['Stickers'], count: 3 },
    { municipio: 'Santa Fe de Antioquia', comite: 'Comunicaciones', profesion: 'Educacion', publicidad: ['Digital', 'Volantes'], count: 3 },
  ];
...
const GestionVoluntarios: React.FC<GestionVoluntariosProps> = ({
  ...
  const analysis = useMemo(() => {
    ...
    return {
      ...
      subregiones: toRows(subregiones, signals.length),
